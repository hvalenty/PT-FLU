...
double ratio = x1/y1;
FILE * fp1 = fopen("mean_vs_xF_CFR.txt", "r"); // epsilon factor

FILE *fp2 = fopen("protonAsymmetryPT_CFR.txt", "r"); //A_LU

FILE *fp4 = fopen("FLU_PT_CFR_Tab.txt", "w"); //F_LU
int n=0;
...
c03->Print("FLU_PT_CFR_Comp_a.png");
